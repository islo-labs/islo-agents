...
sudo mkdir -p /opt/red-team-cli/bin /opt/red-team-cli/harness /opt/red-team-cli/prompts
sudo rsync -a "${ROOT}/snapshot-src/bin/" /opt/red-team-cli/bin/
...
sudo chmod 0755 /opt/red-team-cli/bin/red-team-cli
...
test -x /opt/red-team-cli/bin/red-team-cli
