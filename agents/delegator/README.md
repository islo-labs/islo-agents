...
Deterministic events stay on their own triggers (issue label → `implementor`, PR open → `review`, etc.). Mentions go through the delegator because a human message needs interpretation.
