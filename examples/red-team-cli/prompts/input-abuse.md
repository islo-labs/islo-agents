...
Audit how **`your-cli`** handles untrusted input across HTTP/WebSocket transport, filesystem bridges, shell invocation, and manifest parsing. Find injection, traversal, confused-deputy, or unsafe parsing issues exploitable in default configurations.
