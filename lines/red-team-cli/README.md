...
Bake a VM with `/workspace/islo-cli/` for white-box stages. Copy
`snapshots/red-team-cli/snapshot-src/` into the paths in
`snapshots/red-team-cli/README.md`, then `islo snapshot save red-team-cli`.
